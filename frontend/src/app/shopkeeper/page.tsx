        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <form onSubmit={handleAddItem} className="space-y-4">
              ...
              <button type="submit" className="w-full bg-green-600 text-white font-bold py-2 rounded-xl hover:bg-green-700">Add to Store</button>
            </form>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {inventory.map(item => (
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-4">
                      <span className={`px-2 py-1 rounded text-xs font-bold ${item.inStock ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
